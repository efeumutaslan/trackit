...
export default function Templates() {
  ...
  return (
    <div className="app-shell">
      <TopBar back title="Şablonlar" />
      <div className="content">
        <Link to="/templates/new" className="btn primary mb-2">+ Yeni şablon</Link>
        {rows.length === 0 ? (
          <div className="empty">
            ...
            <Link to={`/templates/${t.id}`} key={t.id} className="list-row">
              <div className="meta">
                ...
                <div>
                  ...
                  <div className="small text-muted">{t.exercises?.length || 0} egzersiz</div>
                </div>
              </div>
